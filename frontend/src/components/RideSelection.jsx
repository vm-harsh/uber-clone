...
const RideSelection = ({setRidePanelOpen}) => {

  return (
    <div>
        <div className='rounded-t-3xl border-t-2 w-full bg-white pt-5 pb-1 px-2 flex flex-col gap-10'>
            {<FaChevronDown className='absolute right-6 top-6' onClick={()=>setRidePanelOpen(false)}/>} 
            <h1 className='text-2xl font-semibold'>Select a ride</h1>
            <div className='w-full flex items-start justify-between py-2 pr-3 border-2 border-white active:border-black rounded transition duration-200'>
                <div className='flex'>
