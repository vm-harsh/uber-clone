            ...
            <form className='mt-5 flex flex-col items-center justify-center gap-5'>
                <div className='flex gap-3'>
                  <div className='w-full flex flex-col items-start justify-center gap-1'>
                    ...
                    <input required type='email' placeholder='John' className='bg-[#ededed] w-full text-2xl px-3 rounded py-2 outline-none'/>
                  </div>
                  <div className='w-full flex flex-col items-start justify-center gap-1'>
                    <p className='text-xl font-semibold '>LastName</p>
                    <input required type='email' placeholder='Doe' className='bg-[#ededed] w-full text-2xl px-3 rounded py-2 outline-none'/>
                </div>
                </div>
                <div className='w-full flex flex-col items-start justify-center gap-1'>
